...
MODEL_NAME = "openlm-research/openllama-7b"
...
RESULTS_FILE = "results_ollama1.txt"
ERROR_LOG_FILE = "error_log_ollama1.txt"
...
print(full_results)
full_results.to_html("model_scan_results.html")
